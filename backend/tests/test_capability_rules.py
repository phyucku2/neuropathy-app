...
async def test_registry_covers_every_shipped_feature() -> None:
    ...
    # are default OFF until the owner enables them: ingest_wearable (ADR-0035 Phase 1) and
    # ingest_notes (ADR-0045 P2 #27). ingest_symptoms is NOT opt-in: it is the core of the
    # daily neuropathy instrument and defaults ON (ADR-0049 — amends ADR-0034's Phase-1 opt-in).
