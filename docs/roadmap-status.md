...
|---|---|---|---|---|---|
| 1 | Feature toggles API — expose Capability/PatientCapability (model exists, no endpoints); patient self-toggles (B2C) + clinician-managed toggles, consent-aware | ◻️ | ◻️ | ◻️ | ADR needed |
