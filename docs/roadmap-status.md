...
**Wave 2 Android done: the app installs, stores tokens in the Keystore + biometric-unlocks, and has a polished native shell.** iOS still PENDING the user's DUNS + Apple-ID switch; the SMART OAuth native handler rides with Wave 3's EMR-connect UI.
